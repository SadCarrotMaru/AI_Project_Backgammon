...
class Graph_Class:
  ...
  def get_euristics(self, node): ## Needs to be done
...
#board_1 = [[], ['B'], [], [], [], ['W', 'W', 'W'], ['W', 'W', 'W'], ['B'], ['W', 'W', 'W', 'W'], [], [], [], ['B', 'B', 'B'], ['W', 'W', 'W'], [], [], ['B'], ['B', 'B', 'B', 'B'], [], ['B', 'B', 'B', 'B', 'B'], [], [], [], [], ['W', 'W'], []]


#board_2 = [['B'], ['B'], [], [], [], ['W', 'W', 'W'], ['W', 'W', 'W'], [], ['W', 'W', 'W', 'W'], [], [], [], ['B', 'B', 'B'], ['W', 'W', 'W'], [], [], ['B'], ['B', 'B', 'B', 'B'], [], ['B', 'B', 'B', 'B', 'B'], [], [], [], [], ['W', 'W'], []]
